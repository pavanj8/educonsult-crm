...
| [0009](0009-agent-harness-github-actions-execution.md) | Agent harness execution model: GitHub Actions, GitHub Issues as tickets, hard test gate | Accepted — implemented; auto-loop in ADR-0015 | 2026-08-19 |
